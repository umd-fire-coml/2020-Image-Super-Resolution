...
## Results
The following graphic was generated in [`testing.ipynb`](https://github.com/umd-fire-coml/2020-Image-Super-Resolution/blob/master/testing.ipynb) using the weights saved at [`model/weights/r3bs10epochs100weights.h5`](https://github.com/umd-fire-coml/2020-Image-Super-Resolution/tree/master/model/weights).
