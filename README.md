...
Our machine learning project uses a seven-layer Efficient Sub-Pixel Convolutional Neural Network to upscale an image. It extracts feature maps from the low resolution image through a series of six convolutional layers, then applies a sub-pixel convolution layer to assemble them into a super-resolved image. This project is written in TensorFlow and is based on [Real-Time Single Image and Video Super-Resolution Using an Efficient Sub-Pixel Convolutional Neural Network](https://arxiv.org/pdf/1609.05158.pdf). 
...
Learn about this project and use a trained model without any setup by visiting our [Interactive Notebook](https://drive.google.com/file/d/1d-1gZsZnIza1KMHSWT0G3tiDAHePZyUR/view?usp=sharing), hosted by Google Colab. Watch our YouTube video for a high-level demonstration and explanation of the project. 
## Setup
