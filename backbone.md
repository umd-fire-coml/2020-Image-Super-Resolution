...
We set the number of filters to ![equation](https://latex.codecogs.com/gif.latex?r^2) and use `activation = "sigmoid"` in our implementation.

`TODO: Find f6.`
## Output
`tf.nn.depth_to_space` is used on the seventh layer to convert the final convolution to the output image.
